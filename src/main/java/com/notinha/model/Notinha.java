...
public class Notinha {
	...
	public Double getValorNotinha() {
		...
		if (this.itemNotinha !=null){
			this.valorNotinha = 0.0;
			for (ItemNotinha item : itemNotinha) {
				this.valorNotinha = this.valorNotinha + item.getValorTotal();
			}
		}
	...
	public ItemNotinha getItem() {
		return item;
	}

	public void setItem(ItemNotinha item) {
		this.item = item;
	}
